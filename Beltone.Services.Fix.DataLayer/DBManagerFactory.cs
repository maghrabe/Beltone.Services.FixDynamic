    ...
    public sealed class DBManagerFactory
   {
     ...
     public static IDbDataParameter[]GetParameters(DataProvider providerType,int paramsCount)
     {
       ...
       return idbParams;
        ...
        //public IDbConnection EstablishEGID_DatabaseConnection()
        //{
        //    conStr = SystemConfigurations.Initialize(
        //    if (conStr == null || conStr == string.Empty)
        //    {
        //        throw new ArgumentNullException("ETF_ConnectionString", "Parameter not found in configuration file");
        //    }
        //}


        //public IDbConnection EstablishApplication_DatabaseConnection()
        //{ }
        ...
        //public bool GetTable(string query, string filters)
        //{ 
        //}
